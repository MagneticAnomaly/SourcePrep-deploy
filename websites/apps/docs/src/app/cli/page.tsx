      ...
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-sm text-text-muted">
              Global daemon settings and project-level overrides (<code>.sourceprep/config.json</code>).
            </p>
          </a>
        </div>
        ...
        <div className="mt-12 prose  max-w-none">
          ...
          <p>
            The SourcePrep CLI is included with the desktop app and provides a command-line interface

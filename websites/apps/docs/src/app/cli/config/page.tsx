    ...
    <main className="min-h-screen bg-background text-text">
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <div className="mt-12 prose  max-w-none">
          ...
          <p>
            Stored in <code>~/.prep/config.json</code> (Mac/Linux) or <code>%APPDATA%\prep\config.json</code> (Windows).
          </p>
          ...
          <p>
            Stored in the internal SQLite database (managed via CLI/Dashboard). You can also place a <code>.prep/config.json</code> in your project root to override settings for that specific repo.
          </p>

          <h3 className="text-base font-semibold mt-4">.prep/ignore</h3>
          <p>

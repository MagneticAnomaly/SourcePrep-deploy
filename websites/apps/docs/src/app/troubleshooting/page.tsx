        ...
        <div className="mt-12 prose  max-w-none">
          ...
          <div className="space-y-6">
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li>Ensure Prep is running (open the desktop app or run <code>prep serve</code>).</li>
                <li>Check if port 8400 is blocked by a firewall or another process.</li>
                <li>On Windows, you may need to allow Prep through the firewall when prompted.</li>
              </ul>
            </div>
            ...
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li>Restart the Prep desktop app (or the <code>prep serve</code> process if running manually).</li>
          ...
          <div className="space-y-6">
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <p className="text-sm mb-4">
                Prep uses <span className="font-semibold text-text">Native Embeddings</span> (ONNX) by default, which run inside the Prep process without any external dependencies.
              </p>
              <p className="text-sm mb-4">
            ...
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <p className="text-sm text-text-muted mb-4">
                When using Native Embeddings, Prep downloads the model (~300MB) on the first run.
              </p>
              <ul className="list-disc pl-5 space-y-2 text-sm">
          ...
          <div className="space-y-6">
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li><span className="font-semibold text-text">Check coverage:</span> Is the file actually indexed? Run <code>prep coverage</code> or check the dashboard.</li>
                <li><span className="font-semibold text-text">Lower threshold:</span> The default <code>min_score</code> is 0.15. Try <code>prep search &quot;query&quot; --min-score 0.01</code> to see if it&apos;s just a ranking issue.</li>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <p className="text-sm text-text-muted mb-4">
                If <code>prep_search</code> and other tools don&apos;t show up in your editor:
              </p>
              <ul className="list-disc pl-5 space-y-2 text-sm">
          ...
          <div className="space-y-6">
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li>Reduce the number of indexed files by excluding large folders (<code>vendor/</code>, <code>node_modules/</code>) in <code>.prep/ignore</code>.</li>
                <li>Lower the <code>max_file_bytes</code> setting in your project configuration (via Dashboard or <code>.prep/config.json</code>).</li>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border rounded-lg p-6 bg-surface">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                ...
                <li>Check your project's <code>.gitignore</code> (Prep respects this by default).</li>
                <li>Check for a <code>.prep/ignore</code> file.</li>
              </ul>
            </div>

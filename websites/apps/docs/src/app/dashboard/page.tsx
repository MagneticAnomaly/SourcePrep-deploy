    ...
    <main className="min-h-screen bg-background text-text">
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <p className="mt-4 text-xl text-text-muted">
          A comprehensive tour of the Prep desktop interface panels and controls.
        </p>
        ...
        <div className="mt-12 prose  max-w-none">
          ...
          <StoryEmbed
            ...
            height={600}
            caption="The Prep modular dashboard — drag, resize, and arrange panels to your workflow"
          />
          ...
          <p>
            The <span className="font-semibold text-text">Graph Scope</span> panel (left pane) is your inventory control. It defines exactly <em>what</em> code and documentation Prep is allowed to see.
          </p>

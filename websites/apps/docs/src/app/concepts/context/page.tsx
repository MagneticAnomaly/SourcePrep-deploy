    ...
    <main className="min-h-screen bg-background text-text">
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <div className="mt-12 prose  max-w-none">
          ...
          <p>
            Prep gathers candidates from multiple sources:
          </p>
          ...
          <ul className="list-disc pl-5">
            ...
            <li><span className="font-semibold text-text">Query Intent:</span> Prep classifies your query (e.g. &quot;docs&quot;, &quot;tests&quot;, &quot;code&quot;, or &quot;default&quot;) and automatically adjusts role weights. For example, &quot;how to use auth&quot; boosts documentation, while &quot;auth test failure&quot; boosts test files.</li>
          ...
          <p>
            You specify a <code>max_chars</code> or <code>max_tokens</code> budget. Prep:
          </p>
          <ul className="list-disc pl-5">
          ...
          <p>
            When compression is enabled, Prep uses two engines. <span className="font-semibold text-text">Code files</span> are structurally
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-8">
            <div className="rounded-lg border border-border bg-surface p-6">
              ...
              <ul className="space-y-3 text-sm text-text-muted">
                ...
                <li>
                  <span className="font-semibold text-text">Max Chars:</span> The hard limit for the final output. Prep will stop adding chunks once this budget is hit.

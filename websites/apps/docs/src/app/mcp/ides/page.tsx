    ...
    <main className="min-h-screen bg-background text-text">
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <div className="mt-8 prose max-w-none">
          ...
          <p>
            Choose your preferred editor below and copy-paste the configuration. Then restart the window. Ensure the SourcePrep backend is running locally (<code>prep serve</code>) before making requests in the IDE.
          </p>
        </div>

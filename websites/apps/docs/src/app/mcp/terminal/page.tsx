    ...
    <main className="min-h-screen bg-background text-text">
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <div className="mt-8 prose max-w-none">
          <p>
            Terminal-based AI agents operate headless, but still require structural intelligence when modifying your project. Connecting RunPrep locally allows them to execute semantic searches and assess blast radiuses without leaving the command line.
          </p>

          <AnchorHeading id="setup" level="h2">Integration Setup</AnchorHeading>
          <p>
            Select your Terminal AI agent below. Update the respective configuration file with the provided JSON block to register RunPrep as an MCP tool. Ensure the RunPrep daemon is running (<code>prep serve</code>) before starting a chat session in the terminal.
          </p>
        </div>

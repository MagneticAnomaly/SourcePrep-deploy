      ...
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <div className="mt-8 prose  max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <span className="font-semibold text-text">Reliable JSON output:</span> CoDRAG&apos;s pipeline needs structured JSON responses. Qwen3 excels at this.
            </li>
          </ul>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p>
                ...
                3&ndash;20&times;, no model needed. <span className="font-semibold text-text">Language compression</span> for docs uses a lightweight BERT model (~178 MB) to remove filler while preserving meaning.
          ...
          <p>
            CoDRAG isn't tied to one provider. The <span className="font-semibold text-text">Endpoint Manager</span> at the bottom of the AI Models settings allows you to connect to any OpenAI-compatible API.
          </p>

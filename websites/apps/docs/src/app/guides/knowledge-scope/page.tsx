      ...
      <div className="mx-auto max-w-3xl px-6 pb-16 pt-0">
        ...
        <section className="mt-10">
          ...
          <div className="mt-4 p-4 rounded-lg border border-primary/20 bg-primary/5 text-sm">
            <span className="font-semibold text-text">Two halves of CoDRAG&apos;s RAG:</span> The <em>Code Graph</em> (trace) provides
          ...
          <div className="mt-4 space-y-4">
            <div className="rounded-lg border border-border bg-surface p-4">
              ...
              <div className="mt-2 text-sm text-text-muted">
                <span className="font-semibold text-text">Globs</span> (in Project Settings) define the file types CoDRAG can see: <code>**/*.py</code>, <code>**/*.md</code>.

...
export default function IntegrationsPage() {
  return (
    <DetailPageLayout
      ...
      description="CoDRAG connects to Claude Code, Antigravity, Cursor, Windsurf, VS Code, and any MCP-compatible tool via a single MCP server."
      badge="MCP"
      sections={SECTIONS}
      docsUrl="https://docs.codrag.io/integrations"
    ...
    >
      ...
      <section id="universal">
        ...
        <p className="text-text-muted leading-relaxed mb-6">
          CoDRAG is a single MCP server that connects to any tool supporting the Model Context Protocol.
          Run <code className="text-primary font-mono text-sm">codrag serve</code> once, and every editor in your workflow
      ...
      <section id="claude-code">
        ...
        <p className="text-text-muted leading-relaxed mb-6">
          Claude Code receives CoDRAG's deepest integration. The full suite of MCP tools is designed around Claude Code's
      ...
      <section id="antigravity">
        ...
        <p className="text-text-muted leading-relaxed mb-6">
          Antigravity's agentic editing mode pairs naturally with CoDRAG's structural intelligence — giving agents
      ...
      <section id="cursor-windsurf">
        ...
        <p className="text-text-muted leading-relaxed mb-6">
          Both Cursor and Windsurf support MCP natively. CoDRAG plugs in without any special configuration and adds
        ...
        <div className="rounded-lg border border-border bg-surface p-6">
          ...
          <ul className="space-y-2 text-sm text-text-muted">
            ...
            <li className="flex items-start gap-2"><span className="text-primary mt-0.5">→</span> Works alongside their built-in AI features — CoDRAG adds structural depth they don't have</li>
          </ul>
        </div>
      </section>
      ...
      <section id="vscode">
        ...
        <p className="text-text-muted leading-relaxed mb-6">
          CoDRAG ships a native VS Code extension with a sidebar UI for semantic search, context assembly, and trace navigation —
      ...
      <section id="client-aware">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          CoDRAG auto-detects which client is connecting via MCP <code className="text-primary font-mono text-sm">clientInfo</code>.
        ...
        <a
          href="https://docs.codrag.io/integrations"
          target="_blank"

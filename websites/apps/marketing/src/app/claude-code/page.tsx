...
const SECTIONS = [
  { id: 'why', label: 'Why Claude Code + SourcePrep' },
...
export default function ClaudeCodePage() {
  return (
    <DetailPageLayout
      ...
      description="SourcePrep is purpose-built for Claude Code. Six MCP tools, auto-approve safety, skills integration, and client-aware content delivery."
      badge="Integration"
      sections={SECTIONS}
      docsUrl="https://docs.sourceprep.io/integrations/claude-code"
      docsLabel="Claude Code setup guide"
    >
      {/* Why Claude Code + SourcePrep */}
      <section id="why">
        <h2 className="text-2xl font-semibold text-text mb-4">Why Claude Code + SourcePrep</h2>
        <p className="text-text-muted leading-relaxed mb-6">
          Claude Code is the most capable AI coding CLI — it reasons, plans, and executes across an entire codebase.
          But even the best model is limited by what context it can see. SourcePrep gives Claude Code structural codebase
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              title: 'Agent-Native',
              desc: 'SourcePrep is designed for autonomous agentic loops — low noise, high signal, source-cited.',
            },
            {
              icon: <Zap className="w-5 h-5" />,
              title: 'Zero Ramp-Up',
              desc: 'Call prep once at the start of any task. Structural context lands in seconds.',
            },
          ].map((item) => (
      ...
      <section id="tools">
        ...
        <p className="text-text-muted leading-relaxed mb-6">
          SourcePrep registers six MCP tools with Claude Code. Each is read-only and purpose-built for a specific
      ...
      <section id="auto-approve">
        ...
        <div className="rounded-lg border border-border bg-[#0d1117] p-5 font-mono text-sm mb-4">
          ...
          <div className="pl-8 text-[#e6edf3]">
            ...
            <span className="text-[#e6edf3]">{": ["}</span>
            <span className="text-[#a5d6ff]">&quot;mcp__prep&quot;</span>
            <span className="text-[#e6edf3]">{"]"}</span>
          </div>
        ...
        <p className="text-sm text-text-muted">
          SourcePrep also generates a <code className="text-primary font-mono text-xs">.claude/skills/</code> file
      ...
      <section id="agents-md">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          SourcePrep auto-generates an <code className="text-primary font-mono text-sm">AGENTS.md</code> file at the
        ...
        <div className="space-y-3 mb-6">
          {[
            ...
            { label: 'Tool Instructions', desc: 'Front-loaded, aggressive instructions telling Claude Code to call prep immediately at task start' },
          ].map((item) => (
        ...
        <p className="text-sm text-text-muted">
          The file is regenerated whenever SourcePrep rebuilds the index. User additions outside the managed block
      ...
      <section id="client-aware">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          SourcePrep detects it&apos;s talking to Claude Code and tailors content delivery accordingly. Claude Code gets
        ...
        <a
          href="https://docs.sourceprep.io/integrations/claude-code"
          target="_blank"

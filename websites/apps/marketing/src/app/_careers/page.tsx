...
const OPEN_POSITIONS: JobListing[] = [
  ...
  },
  {
    ...
    type: 'Full-time',
    description:
      'Own the SourcePrep desktop experience built with Tauri + React. Design and implement the modular dashboard, project management UI, and real-time build status. Ship features that developers interact with daily.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Contract',
    description:
      'Help developers understand why structured context matters for AI-assisted development. Write tutorials, create demos, engage with the community, and represent SourcePrep at conferences and in online developer spaces.',
    requirements: [
                  ...
                  >
                    ...
                    <div className="lg:col-span-3 flex items-start justify-end">
                      <Button asChild variant="outline" className="rounded-none border-2">
                        <a href={`mailto:careers@sourceprep.io?subject=${encodeURIComponent(job.title + ' — ' + job.id)}`}>
                          Apply &rarr;
                        </a>
                      </Button>
                    </div>
        ...
        <div className="mt-24 border-t border-border pt-12 grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="lg:col-span-4 flex items-center justify-end">
             <Button asChild size="lg" className="rounded-none text-lg px-8 py-6">
                <a href="mailto:careers@sourceprep.io?subject=General Application">Get in Touch</a>
             </Button>
           </div>
        </div>

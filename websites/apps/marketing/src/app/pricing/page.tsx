        ...
        <div className="mt-12 text-center max-w-3xl mx-auto">
          {IS_BETA_MODE && (
            <div className="mb-6 inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
              ...
              RunPrep is currently in closed beta. Prices below indicate our upcoming structure.
            </div>
          )}
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-border bg-surface p-6 flex flex-col">
            ...
            <p className="mt-3 text-sm text-text-muted">
              Try RunPrep on up to 3 projects. Experience the magic of real-time structural intelligence.
            </p>
            ...
            <Button asChild variant="outline" className="mt-6 w-full">
              {IS_BETA_MODE ? (
                <a href="mailto:support@runprep.io?subject=RunPrep%20Beta%20Access%20Request%20-%20Free%20Tier">Join Free Beta</a>
              ) : (
          ...
          <div className="rounded-xl border border-border bg-surface p-6 flex flex-col">
            ...
            <Button asChild variant="outline" className="mt-6 w-full">
              {IS_BETA_MODE ? (
                <a href="mailto:support@runprep.io?subject=RunPrep%20Beta%20Access%20Request%20-%20Pro%20Monthly%20Tier">Request Beta Access</a>
              ) : (
          ...
          <div className="rounded-xl border-2 border-primary bg-gradient-to-br from-primary/5 to-transparent p-6 flex flex-col relative">
            ...
            <Button asChild className="mt-6 w-full">
              {IS_BETA_MODE ? (
                <a href="mailto:support@runprep.io?subject=RunPrep%20Beta%20Access%20Request%20-%20Pro%20Perpetual%20Tier">Request Beta Access</a>
              ) : (
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-border bg-surface p-6">
            ...
            <div className="mt-4 flex items-center gap-3">
              <Button asChild variant="outline">
                {IS_BETA_MODE ? (
                  <a href="mailto:support@runprep.io?subject=RunPrep%20Beta%20Access%20Request%20-%20Team%20Tier">Request Beta Access</a>
                ) : (
          ...
          <div className="rounded-xl border border-border bg-surface p-6">
            ...
            <div className="mt-4 flex items-center gap-3">
              <Button asChild variant="outline">
                {IS_BETA_MODE ? (
                  <a href="mailto:support@runprep.io?subject=RunPrep%20Beta%20Access%20Request%20-%20Enterprise%20Tier">Request Enterprise Beta</a>
                ) : (
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-text-muted">
                Each developer&apos;s RunPrep downloads the latest index on startup.

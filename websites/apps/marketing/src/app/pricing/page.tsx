      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-12 text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-xl text-text-muted leading-relaxed">
            Private by design. Sovereign context. SourcePrep ships with built-in ONNX embeddings so
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-border bg-surface p-6 flex flex-col">
            ...
            <Button asChild variant="outline" className="mt-6 w-full">
              {IS_BETA_MODE ? (
                <a href="mailto:support@sourceprep.io?subject=SourcePrep%20Beta%20Access%20Request%20-%20Free%20Tier">Join Free Beta</a>
              ) : (
          ...
          <div className="rounded-xl border border-border bg-surface p-6 flex flex-col">
            ...
            <Button asChild variant="outline" className="mt-6 w-full">
              {IS_BETA_MODE ? (
                <a href="mailto:support@sourceprep.io?subject=SourcePrep%20Beta%20Access%20Request%20-%20Pro%20Monthly%20Tier">Request Beta Access</a>
              ) : (
          ...
          <div className="rounded-xl border-2 border-primary bg-gradient-to-br from-primary/5 to-transparent p-6 flex flex-col relative">
            ...
            <Button asChild className="mt-6 w-full">
              {IS_BETA_MODE ? (
                <a href="mailto:support@sourceprep.io?subject=SourcePrep%20Beta%20Access%20Request%20-%20Pro%20Perpetual%20Tier">Request Beta Access</a>
              ) : (
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-border bg-surface p-6">
            ...
            <div className="mt-4 flex items-center gap-3">
              <Button asChild variant="outline">
                {IS_BETA_MODE ? (
                  <a href="mailto:support@sourceprep.io?subject=SourcePrep%20Beta%20Access%20Request%20-%20Team%20Tier">Request Beta Access</a>
                ) : (
                  <a href={getCheckoutUrl(LS_CHECKOUT_URLS.team, country)}>Start Team Trial</a>
                )}
              </Button>
              <a href="https://docs.sourceprep.io/guides/team-sync" className="text-xs text-primary hover:underline">
                Setup guide &rarr;
              </a>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-border bg-surface p-6">
            ...
            <div className="mt-4 flex items-center gap-3">
              <Button asChild variant="outline">
                {IS_BETA_MODE ? (
                  <a href="mailto:support@sourceprep.io?subject=SourcePrep%20Beta%20Access%20Request%20-%20Enterprise%20Tier">Request Enterprise Beta</a>
                ) : (
                  <a href="/contact">Contact Sales</a>
                )}
              </Button>
              <a href="https://docs.sourceprep.io/guides/enterprise-deploy" className="text-xs text-primary hover:underline">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-text-muted">
                Each developer&apos;s SourcePrep downloads the latest index on startup.

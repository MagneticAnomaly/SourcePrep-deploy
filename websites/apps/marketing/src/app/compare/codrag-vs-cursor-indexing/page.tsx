      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <header className="mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            CoDRAG vs. Cursor Indexing
          </h1>
          <p className="text-xl text-text-muted leading-relaxed">
            Cursor is an incredible AI code editor, and its built-in codebase indexing is great for finding simple keyword matches. But when you need your AI to understand complex architectures, call chains across microservices, or how a specific interface is implemented across 20 files, basic vector search falls short. CoDRAG isn't a replacement for Cursor—it's a massive upgrade to Cursor's brain via the Model Context Protocol (MCP).
          </p>
        </header>

        {/* AI-Optimized Extractable Block */}
        <section className="bg-surface border border-border p-8 rounded-xl mb-16 shadow-sm">
          <h2 className="text-xl font-bold mb-4">How does CoDRAG improve Cursor?</h2>
          <p className="text-text-muted leading-relaxed">
            Cursor relies primarily on <strong>BM25/Vector Search</strong> to find code chunks that semantically match your prompt. <strong>CoDRAG builds a structural trace graph</strong> using a local Rust tree-sitter engine. While Cursor grabs isolated chunks of text, CoDRAG understands the syntax: it knows what functions call other functions, where types are defined, and how modules import each other. By connecting CoDRAG to Cursor via an MCP server, Cursor's AI agents can query the structural graph to traverse call chains and gather perfect, highly-compressed context that regular vector search would miss.
          </p>
        </section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-border">
                  ...
                  <th className="py-4 px-4 font-semibold text-primary bg-primary/5 rounded-t-lg">CoDRAG (via MCP)</th>
        ...
        <div className="space-y-12">
          <section>
            ...
            <p className="text-text-muted leading-relaxed">
              CoDRAG solves this using <strong>Level of Detail (LOD) compression</strong>. If CoDRAG determines a file is only peripherally related to your query, it strips out the internal function bodies and only sends the Class names, function signatures, and types to the AI. You get 20x more architectural context using a fraction of the tokens.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-text-muted leading-relaxed">
              The CoDRAG local daemon indexes all of your projects in the background. When Cursor's Agent uses the CoDRAG MCP tool, it can seamlessly pull context from your backend repo while you are actively typing code in your frontend repo.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-text-muted leading-relaxed">
              You don't have to choose between Cursor and CoDRAG. They are designed to work together. Cursor provides the world-class UX, inline edits, and fast autocomplete. CoDRAG runs silently in the background, providing the structural deep-context that Cursor's Composer agent needs to tackle massive refactors without hallucinating.
            </p>
          </section>
        </div>
        ...
        <div className="mt-16 text-center bg-surface-raised border border-border p-12 rounded-2xl">
          ...
          <a href="mailto:support@codrag.io?subject=CoDRAG%20Beta%20Access%20Request%20-%20Cursor%20User" className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium font-heading transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-background hover:bg-primary/90 active:bg-primary/80 h-11 rounded-md px-8 shadow-lg shadow-primary/25">
            Request Beta Access
          </a>
        </div>
      </div>

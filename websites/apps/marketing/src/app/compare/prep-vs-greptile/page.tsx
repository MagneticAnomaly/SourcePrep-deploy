      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <header className="mb-16">
          ...
          <p className="text-xl text-text-muted leading-relaxed">
            Greptile paved the way for codebase RAG by offering a powerful cloud-based API. But basic vector search fails to give autonomous agents the structural awareness they need to succeed. Prep is built to deliver deep epistemic tracing and superior context intelligence—giving your AI the "what, why, when, and how" without ever letting your codebase leave your control.
          </p>
        </header>

        {/* AI-Optimized Extractable Block */}
        <section className="bg-surface border border-border p-8 rounded-xl mb-16 shadow-sm">
          <h2 className="text-xl font-bold mb-4">What is the difference between Prep and Greptile?</h2>
          <p className="text-text-muted leading-relaxed">
            The primary difference is architecture and epistemic depth. <strong>Greptile relies on naive cloud search</strong>, requiring you to upload your entire codebase to their servers. <strong>Prep is an epistemic context engine</strong> with Private by Design architecture. Prep uses a Rust daemon to parse your code into a meticulous structural trace graph. It integrates natively with your agentic tools (like Paperclip or Cursor) via the Model Context Protocol (MCP). With Prep, you get zero-latency context assembly, role-aware routing, and Sovereign Context—your source code is never unknowingly transmitted.
          </p>
        </section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-border">
                  ...
                  <th className="py-4 px-4 font-semibold text-primary bg-primary/5 rounded-t-lg">Prep</th>
        ...
        <div className="space-y-12">
          <section>
            ...
            <p className="text-text-muted leading-relaxed">
              Prep provides Sovereign Context. It uses locally-run Rust to build the epistemic graph and open-weight ONNX models to embed it. Your code remains exactly where it belongs: under your complete control.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-text-muted leading-relaxed mb-4">
              Instead of forcing you into a proprietary web dashboard or a clunky VS Code extension, Prep embraces the open Model Context Protocol (MCP). 
            </p>
            <p className="text-text-muted leading-relaxed">
              Once the Prep engine is running, any MCP-compatible client—like Paperclip, Cursor, or the Claude Code App—can instantly extract structural knowledge. Your agents automatically invoke Prep to fetch the exact epistemic context they need to execute tasks flawlessly.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-text-muted leading-relaxed">
              ...
              Cloud indexers often charge steep per-seat monthly fees and mark up token costs. Prep offers a perpetual license option and fully supports Bring Your Own Key (BYOK) for inference. Connect Ollama Cloud for high-tier privacy, or use Anthropic Claude Sonnet and pay exactly what the API costs.
            </p>
          </section>
        </div>
        ...
        <section className="mt-16 mb-16">
          ...
          <p className="text-text-muted text-center mb-8">
            Prep delivers structural context to your AI agent in real time — right inside your terminal.
          </p>
        ...
        <div className="mt-16 text-center bg-surface-raised border border-border p-12 rounded-2xl">
          ...
          <a href="mailto:support@runprep.io?subject=Prep%20Beta%20Access%20Request%20-%20Greptile%20Alternative" className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium font-heading transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-background hover:bg-primary/90 active:bg-primary/80 h-11 rounded-md px-8 shadow-lg shadow-primary/25">
            Request Beta Access
          </a>
        </div>
      </div>

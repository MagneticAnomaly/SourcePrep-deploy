          ...
          <div className="lg:col-span-8">
            ...
            <section className="space-y-6 mb-16">
              ...
              <div className="prose  max-w-none">
                <p className="text-lg text-text-muted leading-relaxed">
                  ...
                  not just individual files. SourcePrep provides multiple retrieval methods (semantic search,
            ...
            <aside className="mb-16 rounded-2xl border border-border bg-surface p-6">
              ...
              <p className="text-text-muted leading-relaxed mb-3">
                SourcePrep draws on a long list of papers, repositories, and standards. We keep the working list public.
              </p>
              <a
                href="/research"
                className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline"
              >
                Read the research SourcePrep was built on →
              </a>
            </aside>
          </div>
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <section className="rounded-2xl border border-border bg-surface p-8">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                SourcePrep is built by a small team of engineers who believe developer tools
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-border bg-surface p-5">
              ...
              <div className="mt-1 text-sm text-text-muted">
                SourcePrep provides Sovereign Context. Your source code and indexes stay on your machine.

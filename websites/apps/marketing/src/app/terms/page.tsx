              ...
              <div className="p-8 md:p-12 space-y-16">
                ...
                <section id="overview">
                  ...
                  <div className="max-w-none">
                    <p className="text-lg leading-relaxed border-l-4 border-border pl-6 py-2 text-text-muted">
                      These Terms of Service (&ldquo;Terms&rdquo;) govern your use of SourcePrep software
                      and related services provided by SourcePrep Inc. By downloading, installing, or using SourcePrep, you agree to these Terms.
                    </p>
                  </div>
                </section>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-border p-6 rounded-sm bg-surface-raised">
                       ...
                       <p className="text-sm text-text-muted mb-4">
                         Grants non-exclusive, non-transferable right to use SourcePrep on specified number of machines.
                       </p>
                ...
                <section id="your-data">
                  ...
                  <p className="text-sm text-text-muted leading-relaxed">
                    SourcePrep processes your source code entirely on your local machine. We do not
                ...
                <section id="payments">
                  <h2 className="text-xl font-bold text-text mb-4 flex items-center gap-3">
                   ...
                   <div className="grid grid-cols-[120px_1fr] gap-4 text-sm text-text-muted border-t border-border pt-4">
                      ...
                      <span>14-day money-back guarantee (<a href="mailto:support@sourceprep.io" className="text-primary underline">support@sourceprep.io</a>)</span>
                   </div>
                </section>
                  ...
                  <table className="w-full text-sm text-left border border-border">
                    ...
                    <tbody className="divide-y divide-border">
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-3 text-text-muted">Private Email (support@sourceprep.io)</td>
                      </tr>
                      <tr>

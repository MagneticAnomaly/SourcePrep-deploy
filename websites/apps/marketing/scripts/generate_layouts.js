...
const pages = {
  ...
  changelog: { title: 'Changelog', description: 'Latest updates, features, and improvements to the CoDRAG engine and MCP server.', path: '/changelog' },
  community: { title: 'Community', description: 'Join the CoDRAG community of developers building the next generation of AI-assisted software.', path: '/community' },
  contact: { title: 'Contact Us', description: 'Get in touch with the CoDRAG team for support, enterprise inquiries, or general questions.', path: '/contact' },
  terms: { title: 'Terms of Service', description: 'Terms of service and licensing agreement for CoDRAG.', path: '/terms' },
  privacy: { title: 'Privacy Policy', description: 'CoDRAG privacy policy. We believe your code is your business.', path: '/privacy' },
  careers: { title: 'Careers', description: 'Work with us to build the ultimate local codebase context engine.', path: '/careers' },
  support: { title: 'Support', description: 'Get help with CoDRAG installation, usage, and troubleshooting.', path: '/support' },

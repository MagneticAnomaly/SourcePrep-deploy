  ...
  if (discussions.length === 0) {
    return (
      <div className="text-center py-12 border border-dashed border-border rounded-lg">
        ...
        <div className="mt-6">
          <Button asChild>
            <a href="https://github.com/MagneticAnomaly/Prep-MCP/discussions" target="_blank" rel="noopener noreferrer">
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="outline" size="sm" asChild>
          <a href="https://github.com/MagneticAnomaly/Prep-MCP/discussions" target="_blank" rel="noopener noreferrer" className="gap-2">

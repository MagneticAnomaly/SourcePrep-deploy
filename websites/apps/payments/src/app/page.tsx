    ...
    <main className="min-h-screen bg-background text-text">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
          <div className="rounded-xl border-2 border-primary bg-gradient-to-br from-primary/5 to-transparent p-6 flex flex-col items-center text-center relative">
            ...
            <Button asChild className="mt-4 w-full">
              <a href={CHECKOUT_PRO || 'https://runprep.io/pricing'}>
          ...
          <div className="rounded-xl border border-border bg-surface p-6 flex flex-col items-center text-center">
            ...
            <Button asChild variant="outline" className="mt-4 w-full">
              <a href={CHECKOUT_TEAM || 'https://runprep.io/pricing'}>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3 max-w-4xl mx-auto">
          ...
          <a href="mailto:support@runprep.io" className="rounded-xl border border-border bg-surface p-6 flex flex-col items-center text-center hover:border-primary/50 transition-colors">
            <Mail className="w-6 h-6 text-text-muted mb-2" />
            <h3 className="font-medium">Licensing Support</h3>
            <p className="mt-1 text-xs text-text-muted">support@runprep.io</p>
          </a>

          <a href="https://support.runprep.io" className="rounded-xl border border-border bg-surface p-6 flex flex-col items-center text-center hover:border-primary/50 transition-colors">
        ...
        <div className="mt-16 flex justify-center gap-4">
          <Button asChild variant="outline">
            <a href="https://runprep.io/pricing">View Full Pricing</a>
          </Button>
          <Button asChild variant="outline">
            <a href="https://docs.runprep.io">Documentation</a>
          </Button>
        </div>
      </div>
    </main>

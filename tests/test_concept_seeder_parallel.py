...
def test_concept_seeding_parallel_fans_out_per_module(tmp_path, monkeypatch):
    ...
    with patch("prep.services.project_helpers.require_project", return_value=fake_project), \
         patch("prep.core.project_registry.project_index_dir", return_value=tmp_path), \
         ...
         patch("prep.services.concept_store.concept_store", create=True) as cs_mock:

...
def test_looks_like_prep_self_output_matches_get_context_marker():
    """The 'Get structural codebase context from Prep tools' marker is
    what triggers detection, independent of the frontmatter description."""
    body = (
        "---\n"
        "description: Legacy structural codebase intelligence\n"
        "alwaysApply: true\n"
        "---\n\n"

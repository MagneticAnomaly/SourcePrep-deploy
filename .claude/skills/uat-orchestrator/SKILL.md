...
| Harness plumbing check only | PowerMateReborn `6955793f-…` (15 files) | built | incremental op ≈ 65 s; `--per-iter-timeout 1200` — use to verify the harness itself, not for campaign coverage |

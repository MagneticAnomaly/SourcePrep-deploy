...
4. **Ollama FAQ**: Do NOT change to "No Ollama required". Ollama is the recommended LLM path for enrichment (far cheaper than BYOK). `nomic-embed-text-v2-moe` ONNX compatibility is untested. Keep current Ollama-positive messaging.

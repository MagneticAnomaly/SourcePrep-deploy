...
| Sites with at least one iteration entry | 16 (5 sites now with shipped edits awaiting rerun) | `rules-agents-md`, `concept-validate` (×2), `concept-synthesize`, `concept-t3-refine`, `concept-generate` (×2), `batch-edges` (×2 — partial shipped), `batch-cluster`, `epistemic-code` (×2 — partial shipped), `batch-epi-code` (×2 — partial shipped), `batch-epi-doc` (×2 — partial shipped), `epistemic-doc` (×2 — partial shipped), `hr-agents-md`, `hr-soul-md`, `hr-auto-roles`, `custodian-safety` |

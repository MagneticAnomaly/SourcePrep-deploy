...
| Sites with at least one iteration entry | 16 | `rules-agents-md`, `concept-validate` (×2), `concept-synthesize`, `concept-t3-refine`, `concept-generate` (×2), `batch-edges`, `batch-cluster`, `epistemic-code`, `batch-epi-code`, `batch-epi-doc`, `epistemic-doc`, `hr-agents-md`, `hr-soul-md`, `hr-auto-roles`, `custodian-safety` |

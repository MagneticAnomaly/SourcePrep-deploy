...
- Captured output for this repo: see the live `AGENTS.md` at repo root (referenced in CLAUDE.md context)
- Outputs to capture across all test repos in slot A/B/C

## Iterations

_(none yet — handle with extra care given blast radius)_

...
2. The antibody store DB path for embedded projects (`.runprep/antibodies.db` or similar) may not be resolved correctly by the MCP server's project resolver.

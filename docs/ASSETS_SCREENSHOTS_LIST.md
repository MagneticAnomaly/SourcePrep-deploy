# CoDRAG Screenshot & Image Assets Checklist
...
|---|---|---|
| `hero-dashboard-preview.png` | A hero-quality, stylized screenshot of the CoDRAG dashboard. Should show the two-pane layout with the Knowledge Pipeline active and a search result visible. | `MarketingHero.tsx` |
...
| `docs-cursor-add-modal.png` | The "Add MCP Server" modal in Cursor filled out with CoDRAG details. | `mcp/cursor/page.tsx` |
...
| `docs-getting-started-editor.png` | AI assistant chat panel (Cursor/Windsurf) showing CoDRAG tool being used. | `getting-started/page.tsx` |
| `docs-clara-terminal.png` | Terminal screenshot showing the CLaRa docker container running/starting. | `guides/clara/page.tsx` |
| `docs-clara-settings.png` | CoDRAG settings panel showing CLaRa enabled. | `guides/clara/page.tsx` |
...
- **Theme**: Use the dark theme for all editor and dashboard screenshots to maintain consistency with the CoDRAG brand.
...
- **Anonymization**: Ensure no sensitive personal code or tokens are visible in the screenshots. Use the CoDRAG repo itself as the subject matter for the screenshots.

...
export const LOCAL_MODELS: LocalModel[] = [
  { name: 'qwen3:4b',   size_gb: 2.5, vram_gb: 3,  slot: 'fast',     quality: 5, note: 'Best small model. Rivals 72B models at this size.', ollamaLibrary: 'qwen3' },
  { name: 'qwen3:1.7b', size_gb: 1.4, vram_gb: 2,  slot: 'fast',     quality: 3, note: 'Ultra-light. Decent JSON output.',                  ollamaLibrary: 'qwen3' },
  { name: 'qwen3:0.6b', size_gb: 0.5, vram_gb: 1,  slot: 'fast',     quality: 1, note: 'Smallest option. May produce unreliable JSON.',      ollamaLibrary: 'qwen3' },
  { name: 'qwen3:30b',  size_gb: 19,  vram_gb: 20, slot: 'thinking', quality: 5, note: 'MoE — 30B total, only 3B active. Outstanding reasoning.', ollamaLibrary: 'qwen3' },
  { name: 'qwen3:14b',  size_gb: 9.3, vram_gb: 10, slot: 'thinking', quality: 4, note: 'Strong reasoning. Best mid-range option.',                ollamaLibrary: 'qwen3' },
  { name: 'qwen3:8b',   size_gb: 5.2, vram_gb: 6,  slot: 'thinking', quality: 3, note: 'Good reasoning. Default recommendation.',                ollamaLibrary: 'qwen3' },
  { name: 'qwen3:4b',   size_gb: 2.5, vram_gb: 3,  slot: 'thinking', quality: 2, note: 'Usable for thinking when VRAM is very limited.',         ollamaLibrary: 'qwen3' },
  { name: 'qwen3-coder:30b',  size_gb: 19,  vram_gb: 20, slot: 'code', quality: 5, note: 'MoE — 30B total, 3.3B active. Best code model on Ollama.', ollamaLibrary: 'qwen3-coder' },
  { name: 'qwen2.5-coder:7b', size_gb: 4.7, vram_gb: 5,  slot: 'code', quality: 3, note: 'Specialized for code. Good at edge detection.',            ollamaLibrary: 'qwen2.5-coder' },
];

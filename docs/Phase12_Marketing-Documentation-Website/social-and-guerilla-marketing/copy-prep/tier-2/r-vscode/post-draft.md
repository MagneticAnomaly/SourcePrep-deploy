...
2. **Don't switch editors: Prep adds structural code search to VS Code**
...
### How to use it
If you use an AI extension that supports MCP (like Cline or others coming soon), you just plug Prep in. When you ask a question, it doesn't just guess files—it traces the graph to find exactly the relevant code.

### Why not just "Open File"?
Because Prep prunes the file to just the relevant signatures and implementations, saving your context window for the actual reasoning.

  ...
  return (
    <header className={cn('text-center max-w-3xl mx-auto pb-10 sm:pb-14 border-b border-border', className)}>
      ...
      <p className="text-lg text-text-muted leading-relaxed">
        A working list of the papers, repositories, essays, and standards SourcePrep draws on. Each entry includes a one-line note on how it shaped the project &mdash; and what we changed when we disagreed.
      </p>
    </header>
  );
}

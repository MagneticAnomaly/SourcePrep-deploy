    ...
    <div className={`w-full space-y-8 ${className}`}>
      ...
      <div className="p-5 rounded-xl bg-surface-raised border border-border">
        <p className="text-sm text-text-muted leading-relaxed">
          <span className="font-semibold text-text">SourcePrep ships with everything you need.</span>{' '}
      ...
      <div className="flex items-start gap-3 text-xs text-text-muted">
        ...
        <span>
          <strong>Recommended:</strong> Install SourcePrep — embeddings, search, and context assembly work immediately.

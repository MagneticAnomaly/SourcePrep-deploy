    ...
    <div className="bg-surface-raised min-h-[600px] border-b border-border">
      ...
      <div className="bg-background border-b border-border px-6 py-3 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <span className="font-mono font-bold text-lg tracking-tight flex items-center gap-2"><LayoutGrid className="w-5 h-5" /> SourcePrep</span>
        ...
        <div className="col-span-12 md:col-span-5 flex flex-col justify-center">
          <div className="mb-6">
            ...
            <p className="text-text-muted text-lg leading-relaxed">
              SourcePrep Enterprise standardizes Rust-powered semantic + structural indexing across your
          ...
          <div className="pt-8">
            {isBetaMode ? (
              <Button size="lg" className="w-fit shadow-sm" asChild>
                <a href="mailto:support@sourceprep.io?subject=SourcePrep%20Beta%20Access%20Request%20-%20Enterprise">Contact Sales for Beta</a>
              </Button>
            ) : (
              <Button size="lg" className="w-fit shadow-sm" asChild>

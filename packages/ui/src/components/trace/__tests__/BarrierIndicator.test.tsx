 ...
 * wired in packages/ui as of PR-H (commits b3ca8d5f + dd1ff75c). Use
 * this pattern for syntactic / helper contracts; use the
 * GraphEnrichmentPipeline.behavioral.test.tsx pattern when the

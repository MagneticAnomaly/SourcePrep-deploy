...
const meta: Meta<typeof AnimatedIDE> = {
  ...
  parameters: {
    layout: 'fullscreen',
    docs: { description: { component: 'Simulated IDE split-view with a code editor (left) and an agent chat sidebar (right). Demonstrates CoDRAG MCP tool calls within an agentic IDE workflow.' } },
  },
};

...
const meta: Meta<typeof SystemAgentsTab> = {
  ...
  parameters: {
    layout: 'padded',
    docs: { description: { component: 'Per-agent configuration panel for the three built-in RunPrep agents: HR (Staffing), Researcher, and Digital Custodian. Shows readiness scores, run stats, and action buttons.' } },
  },

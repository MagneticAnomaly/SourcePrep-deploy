...
const meta: Meta<typeof AgentCard> = {
  ...
  parameters: {
    layout: 'padded',
    docs: { description: { component: 'Compact card showing one CoDRAG agent\u2019s status \u2014 name, status badge, key metric, and last run timestamp. Used inside AgentOpsPanel.' } },
  },

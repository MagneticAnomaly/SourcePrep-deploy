...
export const Compression: Story = {
  args: {
    ...
    intro:
      'Why RunPrep\u2019s context assembler ladders code from full source down to one-line signatures.',
...
export const Concepts: Story = {
  args: {
    ...
    intro:
      'Why RunPrep treats concepts as first-class artifacts and where the protocol surface comes from.',

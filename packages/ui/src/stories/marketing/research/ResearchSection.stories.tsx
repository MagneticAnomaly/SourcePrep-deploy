...
export const Compression: Story = {
  args: {
    ...
    intro:
      'Why SourcePrep\u2019s context assembler ladders code from full source down to one-line signatures.',
...
export const Concepts: Story = {
  args: {
    ...
    intro:
      'Why SourcePrep treats concepts as first-class artifacts and where the protocol surface comes from.',

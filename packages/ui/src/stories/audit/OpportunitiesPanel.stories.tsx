...
const mockItems: OpportunityItem[] = [
  {
    ...
    mcp_command: 'codrag_audit action="refactor" finding_ids=["SIZE-1"]',
    created_at: now,
    dismissed_at: '',
  },
  {
    ...
    mcp_command: 'codrag_audit action="refactor" finding_ids=["ARCH-1"]',
    created_at: now,
    dismissed_at: '',
  },
  {
    ...
    mcp_command: 'codrag_audit action="refactor" finding_ids=["QUAL-1"]',
    created_at: now,
    dismissed_at: '',
  },
  {
  ...
  },
  {
    ...
    state: 'active',
    affected_files: ['src/codrag/core/embeddings.py'],
  ...
  },
  {
    ...
    analyzer: 'advisor',
    state: 'active',
    affected_files: ['src/codrag/mcp/auth.py', 'src/codrag/dashboard/auth.py'],

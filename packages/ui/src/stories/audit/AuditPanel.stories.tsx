...
const mockFindings: AuditFinding[] = [
  ...
  },
  {
    ...
    description: 'The named-scopes dropdown (Phase 120) has no integration tests.',
    file_paths: ['src/components/project/FolderTreePanel.tsx'],
    evidence: { coverage_pct: 0, module: 'project' },
    suggested_action: 'Add integration test for scope create/rename/delete callbacks with mock data.',
    finding_id: 'COV-1',
    priority: 'P2',
    effort: 'medium',
  },

...
export const RESEARCH_SOURCES: ResearchSource[] = [
  ...
  },
  {
    ...
    spotlightProse: 'HCP measures the cost of dropping function bodies in favor of signatures across three pruning depths. The result \u2014 ~90% retention of completion quality \u2014 is the empirical backbone for CoDRAG\u2019s LOD 2 default. CoDRAG promotes bodies back to LOD 0 only where the search score crosses a threshold.',
    problemArea: 'compression',
    spotlight: true,
  },
  {
  ...
  },
  {
    ...
    spotlightProse: 'LLMLingua-2 uses a small BERT classifier to drop the lowest-information tokens from a prompt without losing meaning. CoDRAG runs it over Markdown and docstrings while letting code chunks flow through the structural LOD ladder \u2014 two compressors, one assembly. The repo hosts both versions; v2 is what CoDRAG adopts.',
    problemArea: 'compression',
    spotlight: true,
  },
  {
  ...
  },
  {
    ...
    spotlightProse: 'cAST shows that chunking on AST boundaries produces meaningfully better embeddings than fixed-window splits, particularly for languages with strong nesting structure. CoDRAG\u2019s tree-sitter chunker is grounded in this finding \u2014 a chunk never splits mid-function and the chunk header carries the full enclosing path.',
    problemArea: 'chunking',
    spotlight: true,
  },
  {

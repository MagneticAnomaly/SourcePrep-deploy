...
export const RESEARCH_SOURCES: ResearchSource[] = [
  ...
  },
  {
    ...
    spotlightProse: 'Aider\u2019s repo-map prunes a project into one-line signatures and ranks the visible set per turn. It is the public proof that LOD 4 holds up in production across the open-source agentic-coding community. CoDRAG\u2019s context assembler implements a similar selection step on top of the trace graph rather than a flat AST extract.',
    problemArea: 'compression',
    spotlight: true,
  },
  {
  ...
  // ─── Section 3: Code Structure & Chunking ─────────────────────────────
  {
    ...
    usage: 'Catalyst for CoDRAG\u2019s chunking redesign \u2014 informed the semantic chunker and multi-query retrieval.',
    spotlightProse: 'Garry Tan\u2019s gbrain pairs Savitzky\u2013Golay smoothing for semantic boundary detection with reciprocal-rank-fusion across multiple query expansions. Reading it shaped CoDRAG\u2019s current chunker: smooth the similarity curve, cut on local minima, fuse vector and keyword hits with RRF.',

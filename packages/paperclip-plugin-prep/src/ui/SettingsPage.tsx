    ...
    <div style={{ padding: 24, maxWidth: 600 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 13, color: '#888' }}>
          All Paperclip agents can use these SourcePrep tools during their runs:
        </div>
      ...
      <div style={{ fontSize: 12, color: '#666', marginTop: 32 }}>
        SourcePrep v0.1.0 — <a href="https://sourceprep.io" target="_blank" rel="noopener">sourceprep.io</a>
      </div>
    </div>
  );
}

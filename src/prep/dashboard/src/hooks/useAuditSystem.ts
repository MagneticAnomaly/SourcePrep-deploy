...
export function useAuditSystem(
  ...
  return {
    ...
    /** Re-fetch status + findings + reports — hook this into the
     *  pipeline finalize-completed event so the panel reflects results
     *  generated by the orchestrator-driven Run, not just the panel's
     *  own Quick Audit button. */
    refresh: onAuditComplete,
  }
}

...
**Usage from server.py / routers:**
  Import the singleton: ``from prep.services.build_manager import build_manager``
  ...
  to the singleton, so existing ``from prep.server import ...`` in
...
from prep.core import CodeIndex, KnowledgeIndex
from prep.core.events import get_progress_manager
from prep.core.project_registry import Project, project_index_dir
...
class BuildManager:
    ...
    def get_project_layered_index(self, project: Project):
        ...
        from prep.core.layered_index import LayeredCodeIndex

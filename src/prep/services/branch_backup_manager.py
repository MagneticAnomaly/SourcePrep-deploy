...
the current ``.sourceprep/`` trace state is snapshotted and tagged for the
...
def snapshot_project(
    ...
    ``.sourceprep/.branch_snapshots/<branch>/``.
...
def restore_project(
    ...
    Copies all files from ``.sourceprep/.branch_snapshots/<branch>/`` back
    into the live ``.sourceprep/`` directory, overwriting current state.
...
def check_stage_backup(
    ...
    Args:
        index_dir: The project's ``.sourceprep/`` directory.

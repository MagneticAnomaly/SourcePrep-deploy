...
def knowledge_status_project(project_id: str) -> Dict[str, Any]:
    ...
    from prep.server import _require_project, _get_project_knowledge_index, _is_project_knowledge_building
...
def build_knowledge_project(project_id: str) -> Dict[str, Any]:
    ...
    from prep.server import _is_project_knowledge_building, _start_project_knowledge_build
...
def engine_status_project(project_id: str) -> Dict[str, Any]:
    ...
    from prep.api.routers.trace_routes.enrichment import (

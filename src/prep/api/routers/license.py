...
def activate_license(req: ActivateLicenseRequest) -> Dict[str, Any]:
    ...
    if lic_data is None:
        raise ApiException(
            ...
            hint="Purchase a license at https://sourceprep.io/pricing",
        )
...
def provision_seat(req: RecoverLicenseRequest) -> Dict[str, Any]:
    ...
    Currently a placeholder for the api.sourceprep.io integration.
    """
    ...
    try:
        ...
        # In the future, this calls api.sourceprep.io/v1/seats/provision
...
def recover_license(req: ActivateLicenseRequest) -> Dict[str, Any]:
    ...
    the store API key (which lives on api.sourceprep.io, not the desktop app).
    """
    ...
    try:
        ...
        # Recovery is handled via the LS customer portal or payments.sourceprep.io/recover.
        ...
        return ok({
            ...
            "recovery_url": f"https://payments.sourceprep.io/recover?email={email}",
            "instructions": [
        ...
        return ok({
            "recovered": False,
            "message": "Visit https://payments.sourceprep.io/recover to recover your license key.",
            "recovery_url": "https://payments.sourceprep.io/recover",
        })

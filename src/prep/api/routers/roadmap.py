...
def create_node(project_id: str, req: NodeCreate) -> Dict[str, Any]:
    ...
    from prep.core.goalposts_models import RoadmapNode, load_roadmap, save_roadmap
    from prep.core.project_registry import project_index_dir
...
def update_node(project_id: str, node_id: str, req: NodeUpdate) -> Dict[str, Any]:
    ...
    from prep.services.project_helpers import require_project_writable
    from prep.core.goalposts_models import load_roadmap, save_roadmap
    from prep.core.project_registry import project_index_dir
    ...
    if node.tier != old_tier and node.source_ref and "github.com" in (node.source_ref or ""):
        try:
            from prep.core.github_sync import get_github_config
            from prep.core.github_push import sync_tier_change_to_github
...
def trigger_generate(project_id: str) -> Dict[str, Any]:
    ...
    def _run():
        try:
            ...
            from prep.core.goalposts_models import load_roadmap, save_roadmap, RoadmapNode, RoadmapTask
            ...
            from prep.core.goalposts_models import load_roadmap as _lr
...
def trigger_sync_github(project_id: str) -> Dict[str, Any]:
    ...
    def _run():
        try:
            from prep.core.github_sync import GitHubClient, GitHubSyncState
            from prep.core.goalposts_models import load_roadmap, save_roadmap
            from datetime import datetime, timezone
...
async def receive_webhook(project_id: str, request: Request) -> Dict[str, Any]:
    ...
    from prep.core.project_registry import project_index_dir
    from prep.core.goalposts_models import load_roadmap, save_roadmap
    from prep.core.github_webhook import process_webhook_event, verify_webhook_signature
    from prep.core.github_sync import get_github_config
...
def push_to_github(project_id: str, req: PushRequest) -> Dict[str, Any]:
    ...
    from prep.core.goalposts_models import load_roadmap, save_roadmap
    from prep.core.github_sync import get_github_config
    from prep.core.github_push import push_nodes_to_github
...
def suggest_sprint(project_id: str, use_ai: bool = True) -> Dict[str, Any]:
    ...
    from prep.core.project_registry import project_index_dir
    from prep.core.goalposts_models import load_roadmap
    from prep.core.sprint_intelligence import VelocityTracker, SprintPlanner
    ...
    if use_ai:
        try:
            from prep.core.sprint_intelligence import generate_ai_sprint_plan
            import prep.server as _s

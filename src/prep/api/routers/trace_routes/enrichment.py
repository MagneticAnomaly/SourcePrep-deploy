...
def augment_status_project(project_id: str) -> Dict[str, Any]:
    ...
    """
    from prep.server import _require_project, _project_augment_status
    ...
    try:
        from prep.services.build_orchestrator import build_orchestrator, BuildType, BuildPhase
...
def augment_run_project(project_id: str, req: AugmentRequest) -> Dict[str, Any]:
    ...
    from prep.server import _require_project_writable, _get_llm_client_for_task
...
def deep_analysis_status_project(project_id: str, full: bool = False) -> Dict[str, Any]:
    ...
    """
    from prep.server import _require_project, _load_ui_config
    proj = _require_project(project_id)
    idx_dir = project_index_dir(proj)
    ...
    from prep.core import DeepAnalysisOrchestrator, DeepAnalysisSchedule
...
def deep_analysis_run_project(project_id: str, req: DeepAnalysisRequest) -> Dict[str, Any]:
    ...
    from prep.server import _require_project_writable, _get_llm_client_for_task, _load_ui_config
    proj = _require_project_writable(project_id)
...
def deep_analysis_cancel_project(project_id: str) -> Dict[str, Any]:
    ...
    from prep.server import _require_project_writable
...
def index_destroy_project(project_id: str, force: bool = False) -> Dict[str, Any]:
    ...
    try:
        from prep.server import _project_watchers
    ...
    try:
        from prep.services.pipeline_history import pipeline_history
    ...
    try:
        from prep.services.build_orchestrator import build_orchestrator
    ...
    try:
        from prep.services.git_evidence_service import reset_cache as _reset_git_evidence_cache

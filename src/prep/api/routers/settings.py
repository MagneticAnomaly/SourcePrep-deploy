...
def get_admin_policy() -> Dict[str, Any]:
    ...
    """
    from prep.core.team_config import AdminPolicy, parse_admin_policy
...
def get_batch_estimate() -> Dict[str, Any]:
    ...
    """
    from prep.core.batch_profiles import (
        BatchStage,
        resolve_profile,
        PROFILE_OFF,
    )
    ...
    try:
        ...
        active_id = store.get("active_project")
        if active_id:
            from prep.core.project_registry import get_project, project_index_dir

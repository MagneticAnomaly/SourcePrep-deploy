...
async def pipeline_status(project_id: str) -> dict[str, Any]:
    ...
    def _build_status():
        ...
        try:
            from prep.server import _project_augment_status
        ...
        from prep.services.pipeline.stages import STAGE_MANIFEST_FILE as _SMF
        from prep.services.pipeline.stages import StageId as _StageId
        ...
        agent_data = None
        try:
            from prep.services.agent_gate import get_agent_gate
...
def pipeline_budget_usage(project_id: str) -> dict[str, Any]:
    ...
    try:
        from prep.services.pipeline_budget import budget
...
def pipeline_health(project_id: str) -> dict[str, Any]:
    ...
    from prep.services.pipeline.health import collect_pipeline_health
...
async def list_stage_backups(project_id: str, stage_id: str) -> dict[str, Any]:
    ...
    from prep.services.branch_backup_manager import list_snapshots
    from prep.services.pipeline.stages import StageId, stage_manifest_name
    from prep.services.project_helpers import require_project
    from prep.core.project_registry import project_index_dir
...
async def restore_stage_from_snapshot(
    ...
    """
    from prep.services.pipeline.stages import StageId, STAGE_OUTPUT_FILE, stage_manifest_name
    from prep.services.project_helpers import require_project

...
See https://docs.sourceprep.io/guides/byok-batching for the public disclosure.
"""
...
def get_batch_concurrency(provider: str, node_id: str | None = None, model: str | None = None) -> int:
    ...
    try:
        from prep.services.token_telemetry import _telemetry_ctx, _fallback_ctx, _fallback_lock

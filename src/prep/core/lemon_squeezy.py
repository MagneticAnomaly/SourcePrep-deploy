...
Flow:
  1. User buys on runprep.io/pricing → LS generates UUID license key
  2. User enters key in RunPrep → POST /license/activate
...
# Map LS product variant names → RunPrep tiers

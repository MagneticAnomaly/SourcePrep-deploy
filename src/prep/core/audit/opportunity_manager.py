"""
OpportunityManager — Unified opportunity aggregator for Prep (Phase 63).
...
class OpportunityManager:
    ...
    def refresh(
        ...
        if project_root:
            try:
                from prep.core.agents_writer import write_agents_md
    ...
    def _export_markdown(self, items: List[ActionItem]) -> str:
        ...
        lines.append("")
        lines.append("---")
        lines.append("*Generated by Prep codebase intelligence engine*")
    ...
    def _export_ai_prompt(self, items: List[ActionItem]) -> str:
        ...
        lines = [
            "# Prep Codebase Opportunities",
            "",
            "The following opportunities were discovered by Prep's "

...
class LLMClient:
    ...
    def _generate_internal(
        ...
        try:
            from prep.core.content_sanitizer import sanitize_llm_input, validate_llm_output
                    ...
                    try:
                        ...
                        if proj_root:
                            ...
                            if _policy.data.redact_patterns:
                                from prep.core.content_sanitizer import redact_secrets_in_content
        ...
        if effective_provider == "ollama":
            ...
            # CORE: validate output for suspicious patterns
            try:
                from prep.core.content_sanitizer import validate_llm_output
                text, _warnings = validate_llm_output(text)
            except Exception:
                pass
            return text, tokens
    ...
    def _generate_lmstudio(
        ...
        """
        import requests
        from prep.core.model_readiness import _lmstudio_api_base
    ...
    def is_available(self) -> bool:
        ...
        try:
            if self.provider == "lm-studio":
                from prep.core.model_readiness import lmstudio_server_reachable

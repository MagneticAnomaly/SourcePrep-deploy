...
def get_goalposts(project_id: str) -> Dict[str, Any]:
    ...
    from codrag.core.goalposts_models import load_goalposts
    from codrag.core.goalposts_planner import can_generate_goalposts
...
def update_intent(project_id: str, req: IntentUpdate) -> Dict[str, Any]:
    ...
    from codrag.core.project_registry import project_index_dir
    from codrag.core.goalposts_models import load_goalposts, save_goalposts

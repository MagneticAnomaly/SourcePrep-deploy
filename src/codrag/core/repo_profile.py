...
# Files generated by CoDRAG that should be excluded from trace indexing.
# AI agents already have direct access to these files; indexing them is noise.
DEFAULT_EXCLUDE_FILE_NAMES: Set[str] = {
    "AGENTS.md",
}

# Glob patterns for CoDRAG-generated files to exclude from trace indexing.

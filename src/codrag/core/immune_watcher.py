...
from codrag.core.alert_queue import Alert, alert_queue
from codrag.core.antibodies import TriggerType, evaluate_trigger
...
def evaluate_changes(
    ...
    if antibody_store is None:
        from codrag.services.antibody_store import antibody_store as _default_store

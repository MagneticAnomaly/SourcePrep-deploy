...
def headless_create_llm_client(config: HeadlessConfig):
    """Create an LLMClient without importing from codrag.server."""
...
def headless_create_embedder(config: HeadlessConfig):
    """Create an embedder without importing from codrag.server."""
    from codrag.core import NativeEmbedder, OllamaEmbedder
